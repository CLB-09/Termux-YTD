...
# Project name : CLB-09
# Coded by: ABDUL BASIT KAMBOH (You dont become a coder by just changing the credits)
...
echo -e "\e[033m" "For More Awesome and Useful Tool like this Visit My website ©https://github.com/CLB-09"
